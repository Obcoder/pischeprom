...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissions = [
            ...
            'ai_sales.outreach.replies.view',
            'ai_sales.outreach.replies.review',
            'ai_sales.outreach.followups.manage',
            'ai_sales.campaigns.view',
            'ai_sales.campaigns.manage',
            'ai_sales.campaigns.review',
            'ai_sales.campaigns.operate',
            'ai_sales.campaigns.automation.manage',
