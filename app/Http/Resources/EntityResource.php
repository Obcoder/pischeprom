...
class EntityResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'orders_max_submitted_at' => $this->orders_max_submitted_at,
            'avito_chats_count' => $this->whenCounted('avitoChats', fn () => (int) $this->avito_chats_count),
            'avito_unread_chats_count' => $this->whenHas('avito_unread_chats_count', fn () => (int) $this->avito_unread_chats_count),
            'avito_chats' => $this->whenLoaded('avitoChats', fn () => $this->avitoChats->map(fn ($chat) => [
                'id' => $chat->id,
                'peer_name' => $chat->peer_name,
                'title' => $chat->title,
                'is_unread' => $chat->is_unread,
                'unread_count' => $chat->unread_count,
                'waiting_since' => $chat->waiting_since?->toISOString(),
