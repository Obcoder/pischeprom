...
class AvitoAutoReplyController extends Controller
{
    ...
    private function reasonLabels(): array
    {
        return [
            ...
            'customer_details_already_known' => 'Ответ повторно запрашивает данные из переписки — ответит человек',
            'conversation_context_too_large' => 'Вся переписка не помещается в запрос AI — ответит человек',
            'conversation_context_invalid' => 'Не удалось прочитать полный архив переписки — ответит человек',
            'conversation_context_changed' => 'Архив переписки изменился при подготовке ответа — ответит человек',
