...
class CheckCommodityController extends Controller
{
    ...
    public function store(Request $request, ?Check $check = null)
    {
        ...
        $item = DB::transaction(fn () => $this->checkCommodityService->create($check, $data));
    ...
    public function update(Request $request, CheckCommodity $checkCommodity)
    {
        ...
        $item = DB::transaction(
            fn () => $this->checkCommodityService->update($checkCommodity, $data)
        );
    ...
    {
        DB::transaction(fn () => $this->checkCommodityService->delete($checkCommodity));
