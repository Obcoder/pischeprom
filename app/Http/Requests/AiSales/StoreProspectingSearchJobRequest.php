...
class StoreProspectingSearchJobRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'originating_good_ids' => ['sometimes', 'array', 'max:25'],
            'originating_good_ids.*' => ['integer', 'distinct', 'exists:goods,id'],
            'primary_good_id' => ['prohibited'],
            'additional_good_ids' => ['prohibited'],
