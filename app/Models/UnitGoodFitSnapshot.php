...
class UnitGoodFitSnapshot extends Model
{
    use AppendOnlyScoreSnapshot;

    protected array $scoreSubjectFillable = ['unit_good_match_id', 'unit_product_match_id', 'unit_id', 'unit_business_context_id'];
    ...
    {
        return $this->hasMany(UnitGoodFitFactor::class);
    }
