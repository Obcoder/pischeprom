...
case "$1 $2 $3" in
    ...
    'vpc security-group get')
        ...
        printf '{"id":"%s","folder_id":"%s","name":"pischeprom-gis-builder-sg","network_id":"%s","labels":{"managed-by":"pischeprom-gis","lifecycle":"ephemeral"},"rules":[{"description":"builder-egress","direction":"EGRESS","protocol_name":"ANY","cidr_blocks":{"v4_cidr_blocks":["0.0.0.0/0"]}}%s]}\n' \
